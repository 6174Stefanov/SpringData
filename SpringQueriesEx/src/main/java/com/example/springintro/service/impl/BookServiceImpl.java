...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findByReleaseDateBeforeOrReleaseDateAfter(int releaseYear) {
    ...
    @Override
    public List<Book> findByAuthorLastNameStartsWith(String startingWith) {
        return this.bookRepository.findByAuthorLastNameStartingWith(startingWith);
    }
