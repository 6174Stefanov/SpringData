package com.softuni.game_store.entities;
...
public class Game {
    ...
    public Game(String title, String trailerId, String tumbnailURL, float size, BigDecimal price, String description, LocalDate releaseDate) {
        this.title = title;
